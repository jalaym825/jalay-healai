...
def detect_and_translate_to_english(text):
  try:
    ...
    return text  # Return the original text if detection/translation fails
...
class ChatBot:
  ...
  def get_response(self, message, session_id="default"):
    ...
    try:
      ...
      # Translate the message to English before sending to the model
      translated_message = detect_and_translate_to_english(message)
